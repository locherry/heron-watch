...
export default function TabsScreen() {
  ...
  let categoryIdentifierVar = stocksTabs.find(tab => tab.name === currentTabName).data;
  const { data, error, isLoading, isError } = useFetchQuery("/actions/{categoryIdentifier}", "get", {categoryIdentifier : "MP_F"});
  if (isError) {
