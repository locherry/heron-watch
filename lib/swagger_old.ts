...
export interface components {
  schemas: {
    ...
    ErrorResponse: {
      /** @description Code produit */
      errors_in_stocks?: {
        [key: string]: components["schemas"]["batchNumberAssociateErrors"];
      };
    ...
    Error_manager_add_corrupted_data: (
      | components["schemas"]["Error_manager_corrupted_data"]
      | components["schemas"]["Error_manager_corrupted_data"]
    )[];
    ...
    Error_manager_correct_expiration_date: (
      | components["schemas"]["Error_manager_expiration_date"]
      | components["schemas"]["Error_manager_expiration_date"]
    )[];
    /**
    ...
    Error_manager_informations_to_modify: {
      [
        key: string
      ]: components["schemas"]["Error_manager_informations_to_modify_array"];
    };
  };
  responses: never;
  parameters: never;
  ...
  "19a26d65d36aef8861a50d4e0046f618": {
    parameters: {
      query?: {
        ...
        offset?: number;
        /** @description Order by column */
        order_by?: "id" | "product_code" | "batch_number";
        /** @description Sort order: asc or desc */
        sort?: "asc" | "desc";
        /** @description Filter value that appeared multiple times */
        distinct?: boolean;
  ...
  "4ed90574a84499604f4752508d514d14": {
    parameters: {
      query?: {
        ...
        offset?: number;
        /** @description Order by column */
        order_by?: "product_code" | "batch_number" | "quantity";
        /** @description Sort order: asc or desc */
        sort?: "asc" | "desc";
        /** @description Filter value that appeared multiple times */
        distinct?: boolean;
