...
function H5({ className, asChild = false, ...props }: TypographyProps) {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role='heading'
      aria-level='5'
      className={cn(
        'web:scroll-m-20 text-lg text-foreground font-semibold tracking-tight web:select-text',
        className
      )}
      {...props}
    />
...
function H6({ className, asChild = false, ...props }: TypographyProps) {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role='heading'
      aria-level='6'
      className={cn(
        'web:scroll-m-20 text-base text-foreground font-semibold tracking-tight web:select-text',
        className
      )}
      {...props}
    />
